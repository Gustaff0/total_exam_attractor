...
from webapp.views import AnnouncementListView, AnnouncementDetailView, AnnouncementUpdateView, AnnouncementCreateView, announcement_delete_view, ModeratoringListView
